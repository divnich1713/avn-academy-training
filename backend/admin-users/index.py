...
def create_user(event: dict) -> dict:
    ...
    if role not in ("cadet", "instructor", "head_avng", "chief_instructor", "senior_instructor", "junior_instructor", "deputy_head"):
...
def update_user(event: dict, path: str) -> dict:
    ...
    if body.get("role") in ("cadet", "instructor", "head_avng", "chief_instructor", "senior_instructor", "junior_instructor", "deputy_head"):
